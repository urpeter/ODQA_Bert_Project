...
def train(args, batch_dataset, model, tokenizer):
    """ Train the model """
    ...
    for train_dataset in batch_dataset[0]: #TODO following could fuck up the process, but now shouldn't
...
def main():
    ...
    model = ODQAModel.from_pretrained("bert-base-uncased",config=config, return_dict=True)
